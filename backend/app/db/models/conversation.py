...
class Conversation(Base, TimestampMixin):
    ...
    active_knowledge_base_ids: Mapped[list[str]] = mapped_column(
        JSONB, default=list, server_default="[]"
    )
    active_knowledge_document_ids: Mapped[list[str] | None] = mapped_column(
...
class Message(Base, TimestampMixin):
    ...
    effective_config: Mapped[dict | None] = mapped_column(JSONB(none_as_null=True), nullable=True)
